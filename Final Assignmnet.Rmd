...
```{r Seasons, fig.cap="\\label{fig:season} Mean seasonal abundance of each phyla observed at San Nicolas Island, from 1980 to 2011."}
...
```{r Echinodermata before vs after sea otters, fig.cap="\\label{fig:echino} Mean abundance of echinoderms observed at San Nicolas Island, from 1980 to 2011. Gray shading indicates 1982-1983 and 1997-1998 El Nino events. The dashed vertical line represents the 1987 reintroduction of sea otters."}
...
# Abundance of Echinoderms over time, grouped by decade -- *****NOTE:: suggestions for consolidation at the bottom of this code chunk

```{r Decades, fig.cap="\\label{fig:decades} Mean abundance of echinoderms at San Nicolas Island, by decade."}
...
# ***ADDED***** ANOVA testing whether decades is a significant factor in Echinoderm abundance variation:
decades.aov <- summary(aov(data=echinoderm_decades, Abundance~Decades))

# ***ADDED***** Averages and bar graph
...
# ALSO ADDED: This would consolidate the old sea urchins graph with echinoderm species graph ####

```{r decade.facet, fig.cap="\\label{fig:decade.facet} Mean abundance of each echinoderm species observed at San Nicolas Island, by decade."}
...
```{r kelp, fig.cap="\\label{fig:kelp} Mean abundance of each kelp phylum observed at San Nicolas Island, from 1980 to 2011 Gray shading indicates El Nino events; dashed line indicates sea otter reintroduction."}
...
## Statistics: Linear regression to see relationship between annual abundances of brown algae and echinoderms

```{r lm, fig.cap="\\label{fig:lm} Relationship between mean annual abundance of echinoderms and brown algae, including best fit line."}
